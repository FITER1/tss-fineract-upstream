...
ENV FINERACT_DEFAULT_TENANTDB_IDENTIFIER="fiter"
ENV FINERACT_DEFAULT_TENANTDB_NAME="fineract_fiter"
ENV FINERACT_DEFAULT_TENANTDB_DESCRIPTION="Fiter Default Tenant"
